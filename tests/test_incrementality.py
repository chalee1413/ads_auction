...
class TestSignificance:
    ...
    def test_basic_test(self, sample_data):
        ...
        result = check_significance(sample_data["test_outcomes"], sample_data["control_outcomes"])
...
class TestROASvsIROAS:
    ...
    def test_basic_comparison(self):
        ...
        result = compare_roas_iroas(test_revenue, control_revenue, attributed_revenue, ad_spend)
