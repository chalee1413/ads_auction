...
from demo.incrementality import calculate_iroas, calculate_lift, compare_roas_iroas
...
class CampaignSimulator:
    ...
    def simulate(
        ...
        for segment in self.segments:
            ...
            # Conversions
            conversions_treat = np.random.binomial(
                1, segment.conversion_probability(True), n_treat
            )
